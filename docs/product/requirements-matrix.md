...
| AUTH-008 | Must | 账号级可复用简历个人信息 | 用户可编辑简历默认个人信息；新建模板、导入、知识库、JD 定向和 AI 生成简历自动带入且不跨租户 |
...
| RES-002 | Must | PDF 和 DOCX 导出 | 两种文件可打开，中文在 Windows PDF 阅读器中正常显示，且包含预期正文 |
...
| 阶段 | 需求 |
|---|---|
| Phase 1 | AUTH-001 至 AUTH-008、OPS-001、SEC-001 |
